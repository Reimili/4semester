...
if(!empty($_SESSION['username']))
{
    ...
    {
        $fullname_cookie = isset($_COOKIE['fullname']) ? htmlspecialchars($_COOKIE['fullname']) : '';
        $phone_cookie = isset($_COOKIE['phone']) ? htmlspecialchars($_COOKIE['phone']) : '';
        $email_cookie = isset($_COOKIE['email']) ? htmlspecialchars($_COOKIE['email']) : '';
        $bio_cookie = isset($_COOKIE['bio']) ? htmlspecialchars($_COOKIE['bio']) : '';
        $dob_cookie = isset($_COOKIE['dob']) ? htmlspecialchars($_COOKIE['dob']) : '';
